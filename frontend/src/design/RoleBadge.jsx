...
const ROLE_META = {
  ...
  marketing_presupuestos: { label: "Marketing (Presupuestos)", tone: "success" },
  marketing_equipos: { label: "Marketing (Equipos)", tone: "success" },
  marketing_admin: { label: "Marketing (Administrador)", tone: "success" },
  marketing_basico: { label: "Marketing (Básico)", tone: "warning" },
