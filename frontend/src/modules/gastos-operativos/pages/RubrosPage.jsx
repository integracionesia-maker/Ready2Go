...
function RubroModal({ rubro, onClose, onSuccess }) {
...
export default function RubrosPage() {
  ...
  const [error, setError] = useState(null);
  const [modal, setModal] = useState(null); // null | "crear" | rubro (editar)
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => setModal("crear")} className="btn-go">
                  ...
                  {rubros.map((r) => (
                    <tr key={r.id}>
                      ...
                      <td>
                        <RowActions
                          actions={[
                            { key: "editar", label: "Editar", icon: ICONS.editar, onClick: () => setModal(r) },
                            {
                              key: "toggle",
